...
const Wallets = () => {
    ...
    const [deleteWalletData, setDeleteWalletData] = React.useState({});
    ...
    const handleDeleteWallet = (id, name) => {
        setDeleteWalletData({ walletId: id, walletName: name });
    ...
    return (
        <Container maxWidth="sm">
            ...
            <DeleteWalletDialog openDialog={openDeleteDialog} setOpenDialog={setOpenDeleteDialog} walletData={deleteWalletData} />
